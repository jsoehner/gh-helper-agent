...
an Architectural Decision Record (ADR) in docs/adr/ or docs/architecture/decisions/.
...
def main():
    ...
    # Check for ADR update in docs/adr/ or docs/architecture/decisions/
    adr_files = [
        f for f in changed_files
        if (f.startswith("docs/adr/") or f.startswith("docs/architecture/decisions/"))
        and f.endswith(".md")
        and not f.endswith("README.md")
    ]

    if adr_files:
        print(f"\n✅ Architectural Decision Record(s) found:")
        ...
        print("was added or updated in 'docs/architecture/decisions/' or 'docs/adr/'.")
        print("\nRemediation:")
        print("  1. Create a new ADR (e.g. 'docs/architecture/decisions/000X-security-decision-name.md')")
        print("  2. Update 'docs/architecture/decisions/README.md' index table")
        print("  3. Commit the ADR alongside your changes.")
        print("=" * 70 + "\n")
        sys.exit(1)
